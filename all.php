...
<head>
    ...
    <title>LEVERAGE - Employee Management</title>
...
<head>
    ...
    <title>LEVERAGE - Expense Reduction</title>
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/favicon.ico" />
    <!-- Bootstrap -->
    <!-- <link href="assets/css/bootstrap.css" rel="stylesheet"> -->
    <!-- CSS only -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://myleverage.com/solutions/css.php">
                            <img src="assets/images/solutions/equips-card.png" alt="Equips" />
                            <div class="content">
                                <h3>Equips</h3>
                                <div class="rollover">
                                    <p>Equips is revolutionizing how people manage, maintain, and protect critical branch equipment. Leveraging a network of 500+ vendors, experts at Equips help people respond to equipment problems quickly in one place.</p>
                                </div>
                            </div>
                        </a>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://myleverage.com/solutions/css.php">
                            <img src="assets/images/solutions/pop-card.png" alt="Popi/o (CSS)" />
                            <div class="content">
                                <h3>Popi/o (CSS)</h3>
                                <div class="rollover">
                                    <p>POPi/o is the world’s premier provider of video banking solutions that enable easy, convenient, and efficient human interaction</p>
                                </div>
                            </div>
                        </a>
                    </div>
...
<head>
    ...
    <title>LEVERAGE - Liquidity</title>
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/favicon.ico" />
    <!-- Bootstrap -->
    <!-- <link href="assets/css/bootstrap.css" rel="stylesheet"> -->
    <!-- CSS only -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://myleverage.com/solutions/cmg.php">
                            <img src="assets/images/solutions/cmg-card.jpg" alt="CMG Investments" />
                            <div class="content">
                                <h3>CMG Investments</h3>
                                <div class="rollover">
                                    <p>Services such as financial advisement on annuities, brokerage services, commercial mortgage loans, and fiduciary consulting.</p>
                                </div>
                            </div>
                        </a>
                    </div>
...
<head>
    ...
    <title>LEVERAGE - Marketing</title>
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/favicon.ico" />
    <!-- Bootstrap -->
    <!-- <link href="assets/css/bootstrap.css" rel="stylesheet"> -->
    <!-- CSS only -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://myleverage.com/solutions/css.php">
                            <img src="assets/images/solutions/2020-card.png" alt="20/20 Analytics (CSS)" />
                            <div class="content">
                                <h3>20/20 Analytics (CSS)</h3>
                                <div class="rollover">
                                    <p>Global provider of leading customer engagement and payment solutions. Modernized processes, frictionless experiences.</p>
                                </div>
                            </div>
...
<head>
    ...
    <title>LEVERAGE - Non-Interest Income</title>
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/favicon.ico" />
    <!-- Bootstrap -->
    <!-- <link href="assets/css/bootstrap.css" rel="stylesheet"> -->
    <!-- CSS only -->
...
<head>
    ...
    <title>LEVERAGE - Operations</title>
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/favicon.ico" />
    <!-- Bootstrap -->
    <!-- <link href="assets/css/bootstrap.css" rel="stylesheet"> -->
    <!-- CSS only -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://myleverage.com/solutions/css.php">
                            <img src="assets/images/solutions/3si-card.png" alt="3SI" />
                            <div class="content">
                                <h3>3SI</h3>
                                <div class="rollover">
                                    <p>The 3SI name stands for Security, Safety, Service, and Innovation. 3SI Security Systems’ solutions combat credit union crime through tracking, tracing, and SaaS app technology.</p>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://myleverage.com/solutions/css.php">
                            <img src="assets/images/solutions/agility-card.png" alt="Agility Recovery" />
                            <div class="content">
                                <h3>Agility Recovery</h3>
                                <div class="rollover">
                                    <p>Through its business continuity management platform, called Agility Central, Agility works to reduce the impact of business interruptions on credit unions and the communities they serve.</p>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://myleverage.com/solutions/css.php">
                            <img src="assets/images/solutions/illumalogo-card.png" alt="Illuma Lab" />
                            <div class="content">
                                <h3>Illuma Labs</h3>
                                <div class="rollover">
                                    <p>Illuma, a Credit Union Service Organization (CUSO), specializes in voice authentication software that replaces traditional knowledge-based authentication practices in call centers.</p>
                                </div>
                            </div>
                        </a>
                    </div>
...
<head>
    ...
    <title>LEVERAGE - Risk Management</title>
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/favicon.ico" />
    <!-- Bootstrap -->
    <!-- <link href="assets/css/bootstrap.css" rel="stylesheet"> -->
    <!-- CSS only -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://myleverage.com/solutions/cmg.php">
                            <img src="assets/images/solutions/cmg-card.jpg" alt="CMG Credit Union Protection" />
                            <div class="content">
                                <h3>CMG Credit Union Protection</h3>
                                <div class="rollover">
                                    <p>Managing funds and accounts while protecting member relationships and identifying opportunities.</p>
                                </div>
                            </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://myleverage.com/solutions/cmg.php">
                            <img src="assets/images/solutions/cmg-card.jpg" alt="CMG TruStageR Insurance" />
                            <div class="content">
                                <h3>CMG TruStageR Insurance</h3>
                                <div class="rollover">
                                    <p>Products include Accidental Death & Dismemberment (AD&D), Life, Auto & Home insurance.</p>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://myleverage.com/solutions/css.php">
                            <img src="assets/images/solutions/verafin-card.png" alt="Verafin (CSS)" />
                            <div class="content">
                                <h3>Verafin (CSS)</h3>
                                <div class="rollover">
                                    <p>Verafin is the industry leader in enterprise financial crime management, providing a cloud-based, secure software platform for fraud detection and management, BSA/AML compliance and management, high-risk customer management and information sharing.</p>
                                </div>
                            </div>
                        </a>
                    </div>
