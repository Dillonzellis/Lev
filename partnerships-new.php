	...
	<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://myleverage.com/solutions/check-printing.php">
                            ...
                            <div class="content">
                                <h3>Check Printing Solutions</h3>
                                <div class="rollover">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://myleverage.com/solutions/crfadvisors.php">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://www.cunamutual.com/products" target="_blank">
                            <img src="assets/images/solutions/cmg-card.jpg" alt="CUNA Mutual Group" />
                            <div class="content">
                                <h3>CUNA Mutual Group</h3>
                                <div class="rollover rollover-lg">
                                    <p>CUNA Mutual Group is a mutual insurance company that provides financial services to credit unions and their members. CMG sells commercial and consumer insurance and protection products.</p>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://myleverage.com/solutions/css.php">
                            <img src="assets/images/solutions/cuna-strategic-services.png" alt="CUNA Strategic Services" />
                            <div class="content">
                                <h3>CUNA Strategic Services</h3>
                                <div class="rollover rollover-xl rollover-lg">
                                    <p>From the newest products to tried-and-true solutions, CUNA Strategic Services connects credit unions and leagues to the industry's top solution providers. CSS alliances drive membershp, grow revenue, promote operational excellence and foster collaboration.</p>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://myleverage.com/solutions/cufs.php">
                            <img src="assets/images/solutions/cufs-card.png" alt="CUFS" />
                            <div class="content">
                                <h3>CUFS</h3>
                                <div class="rollover">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://myleverage.com/solutions/cusg.php">
                            <img src="assets/images/solutions/cusg-card.png" alt="CUSG" />
                            <div class="content">
                                <h3>CU Solutions Group</h3>
                                <div class="rollover rollover-xl rollover-lg">
                                    <p>CU Solutions Group is a credit union service organization offering leading edge products and services in the areas of technology, marketing, HR performance and strategic advisory.</p>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://myleverage.com/solutions/ddi.php">
                            <img src="assets/images/solutions/ddi-card.png" alt="DDI Technology" />
                            <div class="content">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://www.deluxe.com/financial-institutions/" target="_blank">
				...
				<div class="col-lg-3 col-sm-6">
                    <div class="inner">
                        <a class="event" href="https://myleverage.com/solutions/odp-business-solutions.php">
                            ...
                            <div class="content">
                                <h3>ODP Business Solutions</h3>
                                <div class="rollover">
                                    <p>ODP Business Solutions (formerly known as Office Depot Business Solutions) and LEVERAGE offer a National Buying Program that will maximize savings to Credit Unions of all sizes.</p>
                                </div>
                            </div>
                        </a>
                    </div>
